...
Isaac 是什么见 [第 3 节 仿真环境](#section-3)。

在以isaac为代表的GPU并行环境之前，大多使用cpu集群运行并行环境，例如habitat等

<img width="1457" height="81" alt="image" src="https://github.com/user-attachments/assets/d14b206e-e5fa-4181-8551-82908b338a3c" />
